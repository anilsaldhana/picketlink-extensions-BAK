...
public class SignInEndpoint {
    ...
    public AuthenticationResponse login(final AuthenticationRequest authcRequest) {
        ...
        UsernamePasswordCredentials userPasswordCred = new UsernamePasswordCredentials();
        userPasswordCred.setUsername(authcRequest.getUserId()).setPassword(new PlainTextPassword(authcRequest.getPassword()));
        
        credential.setCredential(userPasswordCred);
